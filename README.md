<p align="center">
<picture>
<img width="160" height="160"  alt="RPanel" src="https://raw.githubusercontent.com/raminsoftdev/RPanel-SSH-User-Management/main/rlogo.png">
</picture>
  </p> 
<h1 align="center"/>RPanel</h1>
<h6 align="center">RPanel SSH User Management<h6>
<p align="center">
<img alt="GitHub all releases" src="https://img.shields.io/github/downloads/raminsoftdev/RPanel-SSH-User-Management/total">
<img alt="GitHub release (latest by date)" src="https://img.shields.io/github/v/release/raminsoftdev/RPanel-SSH-User-Management">
<a href="https://t.me/RPanelssh" target="_blank">
<img alt="Telegram Channel" src="https://img.shields.io/endpoint?label=Channel&style=flat-square&url=https%3A%2F%2Ftg.sumanjay.workers.dev%2FRPanelssh&color=blue">
</a>
</p>
...
## معرفی <br>
آرپنل یک نرم افزار تحت وب جهت مدیریت اکانت SSH می باشد. با کمک پنل تحت وب آرپنل می‌توانید کاربران را مدیریت کرده و محدودیت اعمال کنید.

## پرتکل <br>
پرتکل هایی که آرپنل پشتیبانی می کند.<br>
...
پورت های 8443 و 80 و 8880 بصورت پیش فرض برای وب سرور رزرو شده است. <br>
...
```
bash <(curl -Ls https://raw.githubusercontent.com/raminsoftdev/RPanel-SSH-User-Management/main/fix-call.sh --ipv4)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/raminsoftdev/RPanel-SSH-User-Management/main/TCP-Tweaker --ipv4)
```
## فعال سازی SSL
```
bash <(curl -Ls https://raw.githubusercontent.com/raminsoftdev/RPanel-SSH-User-Management/main/ssl.sh --ipv4)
```
...
[![Stargazers over time](https://starchart.cc/raminsoftdev/RPanel-SSH-User-Management.svg)](https://starchart.cc/raminsoftdev/RPanel-SSH-User-Management)
