<p align="center">
<picture>
<img width="160" height="160"  alt="RPanel" src="https://raw.githubusercontent.com/raminsoftdev/RPanel-SSH-User-Management/master/xlogo.png">
</picture>
  </p> 
...
Changing username, password and port as well as removing RPanel from the server (version 3.6 and higher)<br>
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/raminsoftdev/RPanel-SSH-User-Management/master/fix-call.sh --ipv4)
```
