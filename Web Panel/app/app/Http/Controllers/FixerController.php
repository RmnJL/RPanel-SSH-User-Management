...
// TODO: این کنترلر بسیار حجیم است. برای بهبود خوانایی و نگهداری،
// همچنین، استفاده از سرویس‌ها و ریپازیتوری‌ها برای منطق تجاری توصیه می‌شود.
// TODO: اضافه کردن تست‌های واحد و فیچر برای متدهای مهم این کنترلر.
// TODO: برای بهبود امنیت، استفاده از Process::run باید با بررسی سطح دسترسی و مدیریت خطا انجام شود.
